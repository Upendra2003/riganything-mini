...
if len(args) < 3:
    print("Usage: blender --background --python blender_extract_rig.py -- <fbx_path> <out_json> <mesh_out>")
    sys.exit(1)

fbx_path = args[0]
out_json = args[1]
mesh_out_path = args[2]
...
if mesh_obj is None:
    print("[blender_extract] No mesh found!")
    sys.exit(1)

# Export
bpy.ops.export_scene.obj(filepath=mesh_out_path, use_selection=True)
