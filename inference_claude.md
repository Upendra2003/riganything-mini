...
└── Section 2: Our Model Results        (Phase 7 end-to-end predictions)
    ...
    ├── v2 — 5 Transformer Blocks · 500 Dataset · 70 Epochs
    │   ├── Spyro  [original | v2 rig]    ← data key: spyro_the_dragon_pred_v2
    │   └── Neo    [original | v2 rig]    ← data key: neo_crispytyph_pred_v2
    └── v3 — 5 Transformer Blocks · 1000 Dataset · 150 Epochs  [CURRENT]
        ├── Spyro  [original | v3 rig]    ← data key: spyro_the_dragon_pred_v3
        └── Neo    [original | v3 rig]    ← data key: neo_crispytyph_pred_v3
```
...
| `output/phase7/` | v3 inference outputs (current) |
